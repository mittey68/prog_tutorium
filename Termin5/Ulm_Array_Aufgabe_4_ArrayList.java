...
public class Ulm_Array_Aufgabe_4_ArrayList
{
    public static void main(String[] args) {
        ...
        // do while Schleife, um so viele Konsoleneingaben zu ermöglichen, wie der User wünscht
        boolean again = true;
        do {
        ...
        do {
            ...
            // for-Schleife mit der Länge der ArrayList als Zähler. Achtung: ArrayLists nutzen die Methode size() und nicht length
            for(int i=0; i<data.size(); i++) {
                /* Wenn das gesuchte Element mit dem aktuell im Schleifendurchlauf angesehenen 
                   ...
                   get(i) ist hierbei die ArrayList spezifische Methode für das Wählen einzelner Elemente am Index i*/ 
